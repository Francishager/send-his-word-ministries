            ...
            <div className="max-w-6xl mx-auto px-4 w-full text-white pb-6 md:pb-0">
              <FadeUp>
                ...
                <p className="text-gray-200 mt-2 max-w-2xl">
                  Submit a devotional, testimony, or update. A minister/admin will review and
                  publish.
                </p>
              </FadeUp>
            </div>
            ...
            <form onSubmit={submit} className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    value={form.excerpt}
                    onChange={(e) => on('excerpt', e.target.value)}
                    required
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => on('categoryId', e.target.value)}
                    required
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => on('coverImage', e.target.value)}
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm"
                  />
                  {form.coverImage && (
                    <img
                ...
                <div>
                  ...
                  <input
                    value={form.videoUrl}
                    onChange={(e) => on('videoUrl', e.target.value)}
                  ...
                  <CloudinaryUpload
                    ...
                    accept="video/*"
                    onUploaded={(url) => on('videoUrl', url)}
                    className="mt-2"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <WysiwygEditor
                  ...
                  onChange={(html) => on('contentHtml', html)}
                  className="mb-2"
                />
                <p className="text-xs text-gray-500">
                  Tip: Use the toolbar to format. Upload images/videos above and embed as needed.
                </p>
                <div className="pt-3">
                  <button
                    disabled={saving}
