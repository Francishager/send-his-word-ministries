  ...
  return (
    <PortalLayout userRole={UserRole.ATTENDEE} navItems={navItems} title="Attendee Portal">
      <div className="space-y-4">
        ...
        <p className="text-gray-600">View your giving transactions, statuses, and download receipts.</p>
        <div className="rounded-md border p-4 bg-white">Coming soon: table of giving records with payment statuses and receipt download.</div>
      </div>
    </PortalLayout>
  );
}
